...
if __name__ == '__main__':
    ...
    experiment_name = 'Karman multiple shooting 4 vars, 1e-4 lr 1e-3 wd, linear rhs, 5 layer fc decoder, 100 latent dim, 1e-3 incr (bounded), stable A'
    ...
    shooting = LatentMultipleShooting(signal_dim=trajectory.signal_dim, latent_dim=100, T=trajectory.T, n_shooting_vars=4)
