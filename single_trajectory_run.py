...
if __name__ == '__main__':
    ...
    DATASET = 'SPIRAL'
    experiment_name = 'SPIRAL variational multiple shooting 20 vars, 1024 samples, 2T, 1e-2 lr Adam 5 layers, linear rhs all losses (+ 1e-5 wd + 1e-5 trace) 1e-5 incr, Tanh decoder, 20 latent dim'
    ...
    training_params = {'lambda1': 1e-9, 'lambda2': 1e-9, 'lambda3': 1e-9, 'lambda4': 1e-5,
                       'l2_lambda': 0,
