...
if __name__ == '__main__':
    ...
    DATASET = 'SPIRAL'
    experiment_name = 'SPIRAL 20 shotting_vars,  2T, 1e-2 lr Adam 0.9999 scheduler 10 layers, all losses 1e-3 increment, 64 samples no aggregation'
    ...
    shooting = VariationalLatentMultipleShooting(signal_dim=2, latent_dim=15, n_shooting_vars=20, n_samples=64)
